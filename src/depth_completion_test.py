...
print("Loading image...")
# Define base paths
# Note - data is from KITTI dataset
image_dir = 'data/depth_completion/val_selection_cropped/image/'
depth_dir = 'data/depth_completion/val_selection_cropped/groundtruth_depth/'
